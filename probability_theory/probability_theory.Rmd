...
Moreover, any distribution of probability should be _globally consistent_ over any
...
Indeed we'll want to extend this behavior to local consistency of the probability
...
In particular consider computing the probability assigned to the circle using only
...
$\{ \mathfrak{A}_{1}, \ldots, \mathfrak{A}_{N} \}$, in a certain way to achieve
_sub-additivity_,
$$
...
x \sim \pi.
$$
Here the point $x \in X$ simply denotes the space $X$, $\pi$ denotes
